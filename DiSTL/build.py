...
At a high level the way this works:
    ...
    2. The run process is then structured as follows:
        ...
        This calls many instances of partition_build_count.

        2.b clean_count

        Aggregates the tmp files into one aggregate count file.

        2.c build_vocab

        This calls many instances of partition_build_vocab in parallel.
        ...
        Calls many instances of partition_build_DTM in parallel.  Each of
