...
def eLDA(DTM_dir, out_dir, K, niters=500, alpha=1., beta=1., **kwds):
    """fits a sequential efficient latent dirichlet allocation (LDA)
    ...
    # init model
    mod_l = [init_model(count_f, K=K, V=V, alpha=alpha, beta=beta)
             for count_f in count_fl]
