...
from sLDA_c_methods import sLDA_pass
...
def sdLDA(DTM_dir, out_dir, K, niters=500, alpha=1., beta=1., **kwds):
    """fits a distributed instance of supervised LDA
    ...
    D, V, count_fl, resp_fl = prep_DTM_info(DTM_dir)

    # init model
    mod_l = coord.map(init_model, count_fl, resp_fl, K=K, V=V,
